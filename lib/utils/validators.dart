...
class EmailPassValidator {
  static String validateEmail(String email) {
    if (email.trim().isEmpty) return "Please provide an email";
    if (!emailRegExp.hasMatch(email)) return "Invalid email";
    return null;
  }

  static String validatePassword(String pass) {
    if (pass.trim().isEmpty) return "Please provide a password";
  ...
  static String validateConfirm(String confirm, String pass) {
    if (confirm.trim().isEmpty) return "Please provide a confirm password";
...
class CreateClassValidator {
  static String validateClassTitle(String name) {
    if (name.trim().isEmpty) return "Please provide a class name";
    return null;
  }
}
...
class NewNoteValidator {
  static String validateNote(String note) {
    if (note.trim().isEmpty) return "Please provide a note";
    const len = 1;
...
class JoinClassValidator {
  static String validateCode(String code) {
    if (code.trim().isEmpty) return "Please provide a code";
    const len = 8;
